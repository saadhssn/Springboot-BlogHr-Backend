...
import com.example.BlogHR.services.FileService;
import com.example.BlogHR.services.PostServices;
...
public class PostController {
    ...
    public ResponseEntity<PostDto> uploadImage(@RequestParam("image") MultipartFile image, @PathVariable Long postId) throws IOException, IOException {
        PostDto postDto = postServices.getPostById(postId);
